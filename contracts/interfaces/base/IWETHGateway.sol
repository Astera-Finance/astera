...
interface IWETHGateway {
    function depositETH(address lendingPool, bool reserveType, address onBehalfOf) external payable;

    function depositETHMiniPool(address lendingPool, bool wrap, address onBehalfOf) external payable;
