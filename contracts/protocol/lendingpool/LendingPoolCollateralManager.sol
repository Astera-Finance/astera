    ...
    LendingPoolStorage
{
    ...
    function liquidationCall(
        ...
        DataTypes.ReserveData storage collateralReserve =
            _reserves[collateralAsset][collateralReserveType];
        ...
        debtReserve.updateInterestRates(
            debtAsset, debtReserve.aTokenAddress, vars.actualDebtToLiquidate, 0
        );
        ...
        if (receiveAToken) {
            ...
            vars.collateralAtoken.transferOnLiquidation(
                user, msg.sender, vars.maxCollateralToLiquidate
            );
            ...
            vars.collateralAtoken.burn(
                user, msg.sender, vars.maxCollateralToLiquidate, collateralReserve.liquidityIndex
            );
        }
