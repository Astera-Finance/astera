    ...
    MiniPoolStorage
{
    ...
    function liquidationCall(
        ...
        vars.actualDebtToLiquidate =
            debtToCover > vars.maxLiquidatableDebt ? vars.maxLiquidatableDebt : debtToCover;
        ...
        debtReserve.updateInterestRates(debtAsset, vars.actualDebtToLiquidate, 0);

        if (receiveAToken) {
            vars.liquidatorPreviousATokenBalance =
                vars.collateralAtoken.balanceOf(msg.sender, vars.aTokenID);
            vars.collateralAtoken.transferOnLiquidation(
                user, msg.sender, vars.aTokenID, vars.maxCollateralToLiquidate
            );
            ...
            collateralReserve.updateInterestRates(collateralAsset, 0, vars.maxCollateralToLiquidate);
