...
import {MiniPoolDeploymentHelper, IMiniPoolConfigurator, AsteraDataProvider2} from "contracts/deployments/MiniPoolDeploymentHelper.sol";
...
contract MiniPoolDeploymentHelperTest is Test {
    ...
    address constant AS_USD_MINI_POOL =
    ...
    address constant LINEA_MINI_POOL =
    ...
    function setUp() public {
        ...
        uint256 opFork = vm.createSelectFork(lineaRpc, 24096464);
        assertEq(vm.activeFork(), opFork);
        helper = new MiniPoolDeploymentHelper(
            ORACLE,
            MINI_POOL_ADDRESS_PROVIDER,
            MINI_POOL_CONFIGURATOR,
            DATA_PROVIDER
        );
    }
    ...
    function testCurrentDeployments() public view {
        /* asUSD MiniPool */
        MiniPoolDeploymentHelper.HelperPoolReserversConfig[]
            memory desiredReserves = new MiniPoolDeploymentHelper.HelperPoolReserversConfig[](
                5
            );
        desiredReserves[0] = MiniPoolDeploymentHelper
            .HelperPoolReserversConfig({
                baseLtv: 7500,
                borrowingEnabled: true,
                interestStrat: 0xA294c65B47aCB2297ce950E104C47a50DC8AE42F,
        ...
        desiredReserves[1] = MiniPoolDeploymentHelper
            .HelperPoolReserversConfig({
                baseLtv: 7500,
                borrowingEnabled: true,
        ...
        desiredReserves[2] = MiniPoolDeploymentHelper
            .HelperPoolReserversConfig({
                baseLtv: 8500,
                borrowingEnabled: true,
        ...
        desiredReserves[3] = MiniPoolDeploymentHelper
            .HelperPoolReserversConfig({
                baseLtv: 8500,
                borrowingEnabled: true,
        ...
        desiredReserves[4] = MiniPoolDeploymentHelper
            .HelperPoolReserversConfig({
                baseLtv: 8500,
                borrowingEnabled: true,
        ...
        /* LST MiniPool */
        desiredReserves = new MiniPoolDeploymentHelper.HelperPoolReserversConfig[](
            9
        );
        desiredReserves[0] = MiniPoolDeploymentHelper
            .HelperPoolReserversConfig({
        ...
        desiredReserves[6] = MiniPoolDeploymentHelper
            .HelperPoolReserversConfig({
                baseLtv: 7000,
                borrowingEnabled: true,
        ...
        desiredReserves[7] = MiniPoolDeploymentHelper
            .HelperPoolReserversConfig({
                baseLtv: 7000,
                borrowingEnabled: true,
        ...
        desiredReserves[8] = MiniPoolDeploymentHelper
            .HelperPoolReserversConfig({
                baseLtv: 8500,
                borrowingEnabled: true,
        ...
        (errCode, idx) = helper.checkDeploymentParams(
            LST_MINI_POOL,
            desiredReserves
        );
