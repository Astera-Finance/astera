...
contract TwapOracle is Common {
    ...
    function testSetFallbackOracle() public {
        ...
        // EtherexVolatileTwap etherexVolatileTwap =
        //     new EtherexVolatileTwap(address(tokens[0]), address(tokens[1]), 30 minutes, 1e18, true);
        ...
        // commonContracts.oracle.setFallbackOracle(address(etherexVolatileTwap));
        // assertEq(address(etherexVolatileTwap), commonContracts.oracle.getFallbackOracle());
    }
}
