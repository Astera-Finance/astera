 ...
 */
contract LendingPoolConfiguratorV2 is
    ...
    IAddressProviderUpdatable
{
    ...
    function setIndexUsdt(uint128 newLiquidityIndex) external onlyPoolAdmin {
        if (!isIndexSet) {
            ILendingPoolV2(address(pool)).setIndex(
                0xA219439258ca9da29E9Cc4cE5596924745e12B93, true, newLiquidityIndex
            );
            pool.syncIndexesState(0xA219439258ca9da29E9Cc4cE5596924745e12B93, true);
            pool.syncRatesState(0xA219439258ca9da29E9Cc4cE5596924745e12B93, true);
            isIndexSet = true;
        }
    }
}
