...
contract DeployNewImpl is Script {
    function run() external {
        ...
        LendingPoolV2 newLendingPoolV2 = new LendingPoolV2();
        console2.log("LendingPool Impl V2 deployed at:", address(newLendingPoolV2));

        LendingPoolV3 newLendingPoolV3 = new LendingPoolV3();
        console2.log("LendingPool Impl V3 deployed at:", address(newLendingPoolV3));
